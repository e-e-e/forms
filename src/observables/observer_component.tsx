...
export function observer<T extends {}>(Component: React.FunctionComponent<T>): React.FunctionComponent<T> {
...
export const Observer = React.memo(({children}: { children: () => React.ReactNode }) => {
  const update = useForceUpdate()
